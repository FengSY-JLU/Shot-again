...
# Configuration
We use Python==3.13.2, PyTorch==2.7.1. training on A40 GPU.
# Datasets
Datasets are avaliable in https://drive.google.com/file/d/1wt-nO6-HIT72p70SIAQtUzyOYYywEImM/view?usp=drive_link
# Weights
Pretrained models are avaliable in https://drive.google.com/file/d/1etv9S_qYt7uDfg2HhGcjJ-ddAwYKvY8N/view?usp=drive_link
